...
const isMissingTest262ErrorDefinition = header => { return false;
...
const useESHostError = (code) => {
  return `function Test262Error(message) {
...
class ConsoleAgent extends Agent {
  ...
  async evalScript(code, options = {}) {
    ...
    if (!isExpectingRawSource) {
      code = this.compile(code, attrs, scenario);
    }
    ...
    // return { stderr: code, stdout: '', error: {} };
