...
class D8Agent extends ConsoleAgent {
  constructor(options) {
    ...
    if (options.experimental) {
      // auto generated args
      this.args.unshift("--harmony","--harmony-weak-refs-with-cleanup-some","--harmony-temporal","--harmony-shadow-realm","--harmony-struct","--harmony-array-from-async","--harmony-set-methods","--harmony-intl-best-fit-matcher","--harmony-remove-intl-locale-info-getters","--harmony-intl-locale-info-func","--harmony-intl-duration-format","--harmony-array-grouping","--harmony-iterator-helpers");
    }
  }
