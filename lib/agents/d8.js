...
class D8Agent extends ConsoleAgent {
  constructor(options) {
    ...
    if (options.experimental) {
      // auto generated args
      this.args.unshift("--harmony","--harmony-weak-refs-with-cleanup-some","--harmony-temporal","--harmony-shadow-realm","--harmony-struct","--harmony-import-assertions","--harmony-intl-best-fit-matcher","--harmony-intl-locale-info-func","--harmony-intl-duration-format");
    }
  }
