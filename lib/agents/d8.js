...
class D8Agent extends ConsoleAgent {
  constructor(options) {
    ...
    if (options.experimental) {
      // auto generated args
      this.args.unshift("--harmony","--harmony-shipping","--harmony-temporal","--harmony-shadow-realm","--harmony-struct","--harmony-intl-best-fit-matcher","--harmony-remove-intl-locale-info-getters","--harmony-iterator-helpers","--harmony-set-methods","--harmony-import-attributes");
    }
  }
