...
class JSShell extends ConsoleAgent {
  constructor(options) {
    ...
    if (options.experimental) {
      // auto generated args
      this.args.unshift("--enable-iterator-helpers","--enable-shadow-realms","--enable-array-grouping","--enable-array-from-async","--enable-well-formed-unicode-strings","--enable-change-array-by-copy","--enable-new-set-methods","--enable-top-level-await","--enable-class-static-blocks","--enable-import-assertions");
    }
  }
