...
const prelude = await (await fetch('https://raw.githubusercontent.com/CanadaHonk/porffor/main/test262/prelude.js')).text();
...
class PorfforAgent extends ConsoleAgent {
  ...
  async evalScript(code, options = {}) {
    ...
    code.contents = code.contents.replaceAll(';$262.destroy();', '');
